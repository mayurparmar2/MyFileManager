...
public class FavoritSongs {
    ...
    private String[] ALL_KEYS = {"id", "title", "path", "album", "size", "date", "nametype"};
    private String SQL_CREATE_ENTRIES = "CREATE TABLE " + this.TABLE_NAME + " (" + this.COLUMN_NAME_ID + this.COMMA_SEP + this.TITLE + this.TEXT_TYPE + this.COMMA_SEP + this.PATH + this.TEXT_TYPE + this.COMMA_SEP + this.SIZE + this.TEXT_TYPE + this.COMMA_SEP + this.ALBUM + this.TEXT_TYPE + this.COMMA_SEP + this.DATE + this.TEXT_TYPE + this.COMMA_SEP + this.NAMETYPE + this.TEXT_TYPE + ");";

    public FavoritSongs(Context context) {
    ...
    public FavoritSongs open() {
        this.db = this.myDBHelper.getWritableDatabase();
        return this;
    }

    public FavoritSongs close() {
